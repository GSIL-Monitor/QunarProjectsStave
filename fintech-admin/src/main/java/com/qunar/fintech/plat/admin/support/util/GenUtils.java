...
import com.qunar.fintech.plat.admin.system.dao.entity.ColumnDO;
import com.qunar.fintech.plat.admin.system.dao.entity.TableDO;
...
public class GenUtils {
    ...
    public static String getFileName(String template, String classname, String className, String packageName) {
        ...
        if (template.contains("schedule.html.vm")) {
            return "main" + File.separator + "resources" + File.separator + "src/main/webapp/WEB-INF/templates" + File.separator
        ...
        if (template.contains("query.js.vm")) {
            return "main" + File.separator + "resources" + File.separator + "src/main/webapps/static" + File.separator + "js" + File.separator
